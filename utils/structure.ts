...
export default async function buildStructure() {
    ...
    const csvsGajuMini = [
        `ES_Capital_SERRA_Cível_JEF Cível_${monthnlz}`,
        `ES_Capital_Vitória_Juizados Especiais Federais_${monthnlz}`,
        `ES_Capital_Vitória_Núcleo de Justiça 4.0 Previdenciária_${monthnlz}`,
        `ES_Capital_Vitória_Turma Recursal dos Juizados Especiais _${monthnlz}`,
        `ES_Capital_Vitória_Varas Criminais_${monthnlz}`,
        `ES_Capital_Vitória_Varas Cíveis Especializadas_${monthnlz}`,
        `ES_Capital_Vitória_Varas Cíveis_${monthnlz}`,
        `ES_Capital_Vitória_Varas de Execução Fiscal_${monthnlz}`,
        `ES_Norte - São Matheus, Linhares ou Colatina_Colatina_Varas Mistas_${monthnlz}`,
        `ES_Norte - São Matheus, Linhares ou Colatina_Linhares_Varas Mistas_${monthnlz}`,
        `ES_Norte - São Matheus, Linhares ou Colatina_São Mateus_Varas Mistas_${monthnlz}`,
        `ES_Sul - Cachoeiro de Itapemirim_Cachoeiro de Itapemirim_Criminal_JEF Criminal_Execução Fiscal_${monthnlz}`,
        `ES_Sul - Cachoeiro de Itapemirim_Cachoeiro de Itapemirim_Cível_Execução Fiscal_Ações Tributárias_${monthnlz}`,
        `ES_Sul - Cachoeiro de Itapemirim_Cachoeiro de Itapemirim_Cível_JEF Cível_${monthnlz}`,
        `ES_Sul - Cachoeiro de Itapemirim_Cachoeiro de Itapemirim_Juizados Especiais Federais_${monthnlz}`,
        `ES_Sul - Cachoeiro de Itapemirim_Cachoeiro de Itapemirim_Varas Federais de Execução Fiscal_${monthnlz}`,
        `ES_Sul - Cachoeiro de Itapemirim_Cachoeiro de Itapemirim_Varas Federais Mistas_${monthnlz}`,
        `RJ_Baixada Fluminense_Duque de Caxias_Varas Federais Mistas_${monthnlz}`,
        `RJ_Baixada Fluminense_Nova Iguaçu_Varas Federais Mistas_${monthnlz}`,
        `RJ_Baixada Fluminense_São João de Meriti_Varas Federais Criminais_${monthnlz}`,
        `RJ_Baixada Fluminense_São João de Meriti_Varas Federais Cíveis Especializadas_${monthnlz}`,
        `RJ_Baixada Fluminense_São João de Meriti_Varas Mistas_${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Juizados Especiais Federais_${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Núcleo de Justiça 4.0 Previdenciária_${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Turma Recursal dos Juizados Especiais _${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Varas Federais Criminais_${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Varas Federais Cíveis_${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Varas Federais de Execução Fiscal_${monthnlz}`,
        `RJ_Capital_Rio de Janeiro_Varas Federais Previdenciárias_${monthnlz}`,
        `RJ_Norte Fluminense_Campos_Juizados Especiais Federais_${monthnlz}`,
        `RJ_Norte Fluminense_Campos_Varas Federais Cíveis_${monthnlz}`,
        `RJ_Norte Fluminense_Campos_Varas Federais Previdenciárias_${monthnlz}`,
        `RJ_Norte Fluminense_Campos_Varas Mistas_${monthnlz}`,
        `RJ_Norte Fluminense_Itaperuna_Varas Mistas_${monthnlz}`,
        `RJ_Norte Fluminense_Macaé_Varas Mistas_${monthnlz}`,
        `RJ_Região Serrana_Magé_Varas Mistas_${monthnlz}`,
        `RJ_Região Serrana_Nova Friburgo_Juizados Especiais Federais_${monthnlz}`,
        `RJ_Região Serrana_Nova Friburgo_Varas Federais Cíveis_${monthnlz}`,
        `RJ_Região Serrana_Nova Friburgo_Varas Mistas_${monthnlz}`,
        `RJ_Região Serrana_Petrópolis_Varas Mistas_${monthnlz}`,
        `RJ_Região Serrana_Teresópolis_Varas Federais Mistas_${monthnlz}`,
        `RJ_Região Serrana_Três Rios_Varas Mistas_${monthnlz}`,
        `RJ_Sul Fluminense_Angra dos Reis_Varas Mistas_${monthnlz}`,
        `RJ_Sul Fluminense_Barra do Piraí_Varas Federais Mistas_${monthnlz}`,
        `RJ_Sul Fluminense_Resende_Juizados Especiais Federais_${monthnlz}`,
        `RJ_Sul Fluminense_Resende_Varas Mistas_${monthnlz}`,
        `RJ_Sul Fluminense_Volta Redonda_Juizados Especiais Federais_${monthnlz}`,
        `RJ_Sul Fluminense_Volta Redonda_Varas Mistas_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_Itaboraí_Varas Mistas_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_Niterói_Juizados Especiais Federais_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_Niterói_Varas Federais Criminais_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_Niterói_Varas Federais Cíveis_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_Niterói_Varas Federais de Execução Fiscal_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_Niterói_Varas Mistas_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_São Gonçalo_Varas Federais de Execução Fiscal_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_São Gonçalo_Varas Federais Mistas_${monthnlz}`,
        `RJ_Varas Federais de Niterói e Baixada Litorânea_São Pedro da Aldeia_Varas Mistas_${monthnlz}`,]
